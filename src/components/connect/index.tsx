...
export const Connect = () => {
  return (
    <div className="w-screen bg-customGradient3 text-white flex flex-col md:flex-row p-10 md:px-52 py-20 gap-6">
      ...
      <div className="flex flex-col text-lg md:text-2xl justify-center items-start md:pl-10">
        <p className="mb-8 md:mb-16">
          Passionate about creating impactful solutions? Get in touch to explore
